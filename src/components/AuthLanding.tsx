        ...
        <div className="bg-slate-900/90 border border-slate-800 rounded-3xl p-6 sm:p-8 shadow-2xl backdrop-blur-xl space-y-6">
          ...
          {activeTab === 'login' && (
            <form onSubmit={handleLoginSubmit} autoComplete="off" className="space-y-4">
              ...
              {/* Watermark Note */}
              <div className="pt-3 text-[11px] text-slate-500/35 font-medium tracking-tight text-center select-none pointer-events-none italic opacity-40 border-t border-slate-800/30 mt-3">
